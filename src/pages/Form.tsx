...
function Form() {
    ...
    useEffect(() => {
        axios.get("https://servicodados.ibge.gov.br/api/v1/localidades/estados")
            .then(response => setEstados(response.data.sort((a: Estado, b: Estado) => a.sigla.localeCompare(b.sigla))))    
    }, [])
            ...
            <div>
                <form>
                    <fieldset>
                        ...
                        <div>
                            <label>Nome:
                                <input type="text" id="nome" onChange={handleNameChange} value={cliente.nome} />
                            </label>
                        </div>
